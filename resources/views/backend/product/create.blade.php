            ...
            <div class="body">
                <form id="basic-form" method="post" action="{{route('product.store')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name='title' maxlength="100" value="{{old('title')}}" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <br>
                                <input type="number" value="{{old('price')}}" class="custom_input" step="any" name="price" placeholder="Price (eg. 1000)" value="{{old('price')}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <br>
                                <input type="number" value="{{old('discount')}}" class="custom_input" min="0" max="100" placeholder="Discount (eg. 41)"  name="discount" value="{{old('discount')}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <br>
                                <input type="number" value="{{old('stock')}}" class="custom_input" placeholder="Stock (eg. 10)" name="stock" value="{{old('stock')}}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select id="size" class="custom_input size" name="size" >
                                    ...
                                    <option value="XXL" {{old('size')=='XLL'? 'selected' : ''}}>XXL</option>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select id="parent_category" class="custom_input parent_category" name="parent_category_id">
                                    ...
                                    <option value="{{$category->id}}" {{old('parent_category_id')==$category->id? 'selected': '' }}>{{$category->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
<script>
 var child_cat_id={{old('child_category_id')}}

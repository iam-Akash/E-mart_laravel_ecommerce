                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled team-info margin-0">
                                        <li><img src="{{asset('../assets/backend/images/xs/avatar1.jpg')}}"
                                                title="Avatar" alt="Avatar"></li>
                                        <li><img src="{{asset('../assets/backend/images/xs/avatar6.jpg')}}"
                                                title="Avatar" alt="Avatar"></li>
                                    </ul>
                                </td>
                                <td>$ 356</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled team-info margin-0">
                                        <li><img src="{{asset('assets/backend/images/xs/avatar1.jpg')}}"
                                                title="Avatar" alt="Avatar"></li>
                                        <li><img src="{{asset('assets/backend/images/xs/avatar5.jpg')}}"
                                                title="Avatar" alt="Avatar"></li>
                                        <li><img src="{{asset('assets/backend/images/xs/avatar9.jpg')}}"
                                                title="Avatar" alt="Avatar"></li>
                                    </ul>
                                </td>
                                <td>$ 542</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled team-info margin-0">
                                        <li><img src="{{asset('assets/backend/images/xs/avatar3.jpg')}}"
                                                title="Avatar" alt="Avatar"></li>
                                        <li><img src="{{asset('assets/backend/images/xs/avatar2.jpg')}}"
                                                title="Avatar" alt="Avatar"></li>
                                    </ul>
                                </td>
                                <td>$ 542</td>

            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="single_product_thumb">
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            @php
                                $product_photos= explode(',', $product->photo) 
                            @endphp
                ...
                <div class="col-12 col-lg-6">
                    <div class="single_product_desc">
                        ...
                        <h4 class="price mb-4">{{number_format($product->offer_price, 2)}} <span>{{number_format($product->price, 2)}}</span><div style="display:inline">&nbspTaka</div></h4>
                        ...
                        <div class="sizeguide">
                            ...
                            <div class="size_guide_thumb d-flex">
                                <a class="size_guide_img" href="{{asset('assets/frontend/img/bg-img/size-1.png')}}"
                                    style="background-image: url({{asset('assets/frontend/img/bg-img/size-1.png')}});">
                                </a>
                                <a class="size_guide_img" href="{{asset('assets/frontend/img/bg-img/size-2.png')}}"
                                    style="background-image: url({{asset('assets/frontend/img/bg-img/size-2.png')}});">
                                </a>
                                <a class="size_guide_img" href="{{asset('assets/frontend/img/bg-img/size-3.png')}}"
                                    style="background-image: url({{asset('assets/frontend/img/bg-img/size-3.png')}});">
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                @if ($item->id != $product->id)
                                    ...
                                    <div class="single-product-area">
                                        ...
                                        <div class="product_description">
                                            ...
                                            <h6 class="product-price">{{$product->offer_price}} <span>{{$product->price}} </span> <div style="display:inline">&nbsp Taka</div></h6>
                                        </div>
                                    </div>
                                @endif
                            @endforeach

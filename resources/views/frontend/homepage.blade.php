...
@section('title', 'Emart | Get the best experience.')
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-md-8">
                            <div class="welcome_slide_text">
                                <h4 data-animation="fadeInUp" data-delay="0">{{$banner->title}}</h4>
                                <span data-animation="fadeInUp" data-delay="300ms">{!!$banner->description!!}</span>

...
@section('content')
    ...
    <!-- Quick View Modal Area -->
@php
  $new_products= App\Models\Product::where(['status'=>'active', 'condition'=>'new'])->take(10)->orderBy('id', 'desc')->get();
@endphp
                        ...
                        @foreach ($new_products as $product)
                            <div class="single-product-area">
                                ...
                                <div class="product_description">
                                    ...
                                    <p class="brand_name">{{Str::upper($product->brand->title)}}</p>
                                    <a href="{{route('product.details', $product->slug)}}">{{$product->title}}</a>
                                    <h6 class="product-price">{{$product->offer_price}} <span>{{$product->price}}</span></h6>
                                </div>
                            </div>
                        @endforeach

...
<body>
            ...
            <div class="container">
                <div class="classy-nav-container breakpoint-off">
                    <nav class="classy-navbar" id="bigshopNav">
                        ...
                        <!-- Nav Brand -->
                        <a href="index.html" class="nav-brand"><img src="assets/frontend/img/core-img/logo.png" alt="logo"></a>
                                            ...
                                            <div class="single-mega cn-col-2">
                                                <div class="megamenu-slides owl-carousel">
                                                    <a href="shop-grid-left-sidebar.html">
                                                        <img src="assets/frontend/img/bg-img/mega-slide-2.jpg" alt="">
                                                    </a>
                                                    <a href="shop-list-left-sidebar.html">
                                                        <img src="assets/frontend/img/bg-img/mega-slide-1.jpg" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="hero_meta_area ml-auto d-flex align-items-center justify-content-end">
                                    ...
                                    <ul class="cart-list">
                                        <li>
                                            <div class="cart-item-desc">
                                                <a href="#" class="image">
                                                    <img src="assets/frontend/img/product-img/top-1.png" class="cart-thumb" alt="">
                                                </a>
                                                <div>
                                        ...
                                        <li>
                                            <div class="cart-item-desc">
                                                <a href="#" class="image">
                                                    <img src="assets/frontend/img/product-img/best-4.png" class="cart-thumb" alt="">
                                                </a>
                                                <div>
                                                    <a href="#">Headphone</a>
                            ...
                            <div class="account-area">
                                <div class="user-thumbnail">
                                    <img src="assets/frontend/img/bg-img/user.jpg" alt="">
                                </div>
    ...
    <section class="welcome_area">
        <div class="welcome_slides owl-carousel">
            <!-- Single Slide -->
            <div class="single_slide bg-img" style="background-image: url(assets/frontend/img/bg-img/8.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-5 col-md-4">
                            <div class="welcome_slide_image">
                                <img src="assets/frontend/img/bg-img/slide-1.png" alt="" data-animation="bounceInUp" data-delay="500ms">
            ...
            <!-- Single Slide -->
            <div class="single_slide bg-img" style="background-image: url(assets/frontend/img/bg-img/7.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
            ...
            <!-- Single Slide -->
            <div class="single_slide bg-img" style="background-image: url(assets/frontend/img/bg-img/6.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single_catagory_area mt-50">
                        <a href="#">
                            <img src="assets/frontend/img/bg-img/c1.jpg" alt="">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="single_catagory_area mt-50">
                        <a href="#">
                            <img src="assets/frontend/img/bg-img/c2.jpg" alt="">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="single_catagory_area mt-50">
                        <a href="#">
                            <img src="assets/frontend/img/bg-img/c3.jpg" alt="">
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-5">
                                    <div class="quickview_pro_img">
                                        <img class="first_img" src="assets/frontend/img/product-img/new-1-back.png" alt="">
                                        <img class="hover_img" src="assets/frontend/img/product-img/new-1.png" alt="">
                                        <!-- Product Badge -->
                    ...
                    <div class="new_arrivals_slides owl-carousel">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="assets/frontend/img/product-img/new-1-back.png" alt="">
                                <img class="hover_img" src="assets/frontend/img/product-img/new-1.png" alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="assets/frontend/img/product-img/new-6.png" alt="">
                                <img class="hover_img" src="assets/frontend/img/product-img/new-6-back.png" alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="assets/frontend/img/product-img/new-2.png" alt="">
                                <img class="hover_img" src="assets/frontend/img/product-img/new-2-back.png" alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="assets/frontend/img/product-img/new-4.png" alt="">
                                <img class="hover_img" src="assets/frontend/img/product-img/new-4-back.png" alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="assets/frontend/img/product-img/new-5.png" alt="">
                                <img class="hover_img" src="assets/frontend/img/product-img/new-5-back.png" alt="">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="featured_offer_area d-flex align-items-center" style="background-image: url(assets/frontend/img/bg-img/fea_offer.jpg);">
                    ...
                    <div class="featured_product_slides owl-carousel">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="assets/frontend/img/product-img/new-4.png" alt="">
                                <img class="hover_img" src="assets/frontend/assets/frontend/img/product-img/new-4-back.png" alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="assets/frontend/img/product-img/new-7.png" alt="">
                                <img class="hover_img" src="assets/frontend/img/product-img/new-7-back.png" alt="">
                                ...
                                <div class="top_sellers_area">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/top-1.png" alt="Top-Sellers">
                                                </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/top-2.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Beach Cap</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/top-3.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Gold Neckless</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/top-4.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/top-5.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Sport Shoes</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/top-6.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Pin Up Bikini</h5>
                                ...
                                <div class="best_rated_area">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/best-1.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Sports Bra</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/best-2.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/best-3.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Women Watch</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/best-4.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Headphone</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/best-5.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Plus Bra</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/best-6.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Laptop</h5>
                                ...
                                <div class="on_sale_area">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/onsale-1.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Speaker</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/onsale-2.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Fancy Lamp</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/onsale-3.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Sport Bra</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/onsale-4.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>S'well Water</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/onsale-5.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Slipper</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="assets/frontend/img/product-img/onsale-6.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>T-shirt</h5>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="beach_offer_area mb-4 mb-md-0">
                        <img src="assets/frontend/img/product-img/beach.png" alt="beach-offer">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="apparels_offer_area">
                        <img src="assets/frontend/img/product-img/apparels.jpg" alt="Beach-Offer">
                    ...
                    <div class="weekly_deals_area mt-30">
                        <img src="assets/frontend/img/product-img/weekly-offer.jpg" alt="weekly-deals">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-lg-12">
                            ...
                            <div class="elect_offer_area mt-30 mt-lg-0">
                                <img src="assets/frontend/img/product-img/elect.jpg" alt="Elect-Offer">
                        ...
                        <div class="col-12 col-sm-6 col-lg-12">
                            ...
                            <div class="backpack_offer_area mt-30">
                                <img src="assets/frontend/img/product-img/backpack.jpg" alt="Backpack-Offer">
                ...
                <div class="col-12">
                    <div class="popular_brands_slide owl-carousel">
                        <div class="single_brands">
                            <img src="assets/frontend/img/partner-img/1.jpg" alt="">
                        </div>
                        <div class="single_brands">
                            <img src="assets/frontend/img/partner-img/2.jpg" alt="">
                        </div>
                        <div class="single_brands">
                            <img src="assets/frontend/img/partner-img/3.jpg" alt="">
                        </div>
                        <div class="single_brands">
                            <img src="assets/frontend/img/partner-img/4.jpg" alt="">
                        </div>
                        <div class="single_brands">
                            <img src="assets/frontend/img/partner-img/5.jpg" alt="">
                        </div>
                        <div class="single_brands">
                            <img src="assets/frontend/img/partner-img/6.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-md-7 col-lg-8 col-xl-3">
                    ...
                    <div class="single_footer_area mb-100">
                        ...
                        <div class="apps_download">
                            <a href="#"><img src="assets/frontend/img/core-img/play-store.png" alt="Play Store"></a>
                            <a href="#"><img src="assets/frontend/img/core-img/app-store.png" alt="Apple Store"></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="payment_method">
                            <img src="assets/frontend/img/payment-method/paypal.png" alt="">
                            <img src="assets/frontend/img/payment-method/maestro.png" alt="">
                            <img src="assets/frontend/img/payment-method/western-union.png" alt="">
                            <img src="assets/frontend/img/payment-method/discover.png" alt="">
                            <img src="assets/frontend/img/payment-method/american-express.png" alt="">
                        </div>
                    </div>
                </div>
            </div>

            ...
            <div class="row h-100 align-items-center">
                <div class="col-6">
                    <div class="welcome-note">
                        ...
                        <span class="text">Welcome to Emart ecommerce.</span>
                    </div>
                </div>
                <div class="col-6">
        ...
        <div class="container">
            <div class="classy-nav-container breakpoint-off">
                <nav class="classy-navbar" id="bigshopNav">
                    ...
                    <!-- Nav Brand -->
                    <a href="{{route('homepage')}}" class="nav-brand"><img src="{{asset('assets/frontend/img/core-img/logo.png')}}" alt="logo"></a>
                        ...
                        @auth
                            <div class="account-area">
                                <div class="user-thumbnail">
                                    ...
                                    <img src="{{Helper::userDefaultPhoto()}}" alt="">
                                    @endif
                            ...
                            @else
                            <div>
                               <a href="{{route('user.login-registration')}}"> <i class="fa fa-sign-in mr-2" aria-hidden="true"></i>Login</a>
                                <a href="{{route('user.login-registration')}}" class="ml-2"><i class="fa fa-user-plus mr-2" aria-hidden="true"></i>Registration</a>
                            </div>
                        @endauth
